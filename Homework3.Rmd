...
zero <- - (intercept + agetofifty + agetoforty + agetosixty + agetothirty + incomeone_percent + incomepoor + incomerich + incomevery_rich + (NEP *avg_NEP) +(risk*0) - avg_vote)/bid


four <- - (intercept + agetofifty + agetoforty + agetosixty + agetothirty + incomeone_percent + incomepoor + incomerich +incomevery_rich + (NEP * avg_NEP) + (risk*4) - avg_vote)/bid
...
mean_wtp <- (intercept + agetofifty + (NEP * avg_NEP) + (risk*60) - avg_vote)/-bid
...
*The benefits of the VSR program do not outweigh the costs* 
